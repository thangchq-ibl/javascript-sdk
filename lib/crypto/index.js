...
var getAddressFromPublicKey = function getAddressFromPublicKey(publicKeyHex) {
...
var getAddressFromPrivateKey = function getAddressFromPrivateKey(privateKeyHex) {
...
var generateMnemonic = function generateMnemonic() {
  return _bip.default.generateMnemonic(MNEMONIC_LEN);
};
/**
