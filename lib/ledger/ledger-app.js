  ...
  _createClass(LedgerApp, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var hdPath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [44, 714, 0, 0, 0];
        var result, apduResponse, returnCode, statusCode, statusText, message, stack;
    ...
    key: "_signSendChunk",
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(chunkIdx, chunksCount, chunk) {
        var result, apduResponse, error_code_data, statusCode, statusText, message, stack;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                apduResponse = Buffer.from(apduResponse, "hex");
                error_code_data = apduResponse.slice(-2);
      ...
      function _signSendChunk(_x7, _x8, _x9) {
    ...
    key: "signSecp256k1",
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(signBytes) {
        var hdPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [44, 714, 0, 0, 0];

        var response, chunks, result, statusCode, statusText, message, stack, i, _statusCode, _statusText, _message, _stack, signature, rOffset, rLen, sLen, sOffset, sigR, sigS;
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 60:
                throw new Error("Unable to sign the transaction. Return code " + result.return_code);
